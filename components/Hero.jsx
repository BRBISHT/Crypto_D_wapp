...
const Hero = ({
  ...
  return <div className="banner" id="home" style={{
      ...
      <div className="container">
        <div className="row align-items-center justify-content-between">
          <div className="col-xl-7 col-lg-6">
            <div className="banner-content wow 
            fadeInUp
            "
              data-wow-duration="0"
              data-wow-delay="0.3s"
            >
              <h3 className="subtaitle">Fast and Convenient
              </h3>
              <h1 className="head"> CryptoCurrency Exchange
              </h1>
              <p>
                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                Voluptatem voluptates suscipit expedita ea
                accusamus reiciendis qui nam, dolore a doloribus
                dolor sunt illum. Sequi ea sit est harum vero
                quod?
              </p>
            </div>
          </div>

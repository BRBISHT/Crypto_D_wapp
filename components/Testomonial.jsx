            ...
            <div className="section-head">
              ...
              <p className="text">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                 Ut iusto reiciendis officia tempore tempora totam
                  placeat voluptates illo esse necessitatibus quibusdam
                   quia eum quae debitis soluta.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="client-review">
                    ...
                    <p className="bottom-text">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem 
                       nobis inventore accusantium, aspernatur vero quas exercitationem dolorum 
                       doloribus consequatur.
                    </p>
                    <div className="client-info">
                      <h4 className="name">Damien Yasato</h4>

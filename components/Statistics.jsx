    ...
    <div className="statistic">
      <div className="container">
        ...
        wow fadeInUp"
          ...
          <div className="col-lg-3 col-sm-6 wow
        fadeInUp
        "
            ...
            <div className="content">
              ...
              >
                ...
                <p className="text">
                  ...
                  incidunt, doloribus voluptate asperiores quam.
                  Tempora nihil cupiditate odit earum dolorem!

                  Consequatur nemo voluptates cupiditate.
                </p>
              </div>

              <div className="row justify-content-center">
                <div className="col-xl-4 col-lg-6 wow
                fadeInUp
                "
                  data-wow-duration="0.3s"
                  data-wow-delay="0.3s"
                ...
                <div className="col-xl-4 col-lg-6 wowfadeInUp"
                    data-wow-duration="0.5s"
                    data-wow-delay="0.5s"
                  >
                    <div className="statis-boxx">
